...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/Shinchan7222/ShinchanOP) to open this 🔥**Lit AF!!**🔥 __ShinchanBOT__ Repo.. Join channel :- @Shinchan_USERBOT")
...
async def smrk(smk):
    ...
    if message == "dele":
        await edit_or_reply(smk, message + "te the Shinchan" + "ツ")
