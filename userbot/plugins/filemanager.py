...
async def _(event):
    ...
    process = await asyncio.create_subprocess_sshinchan(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = f"**Files in [ShinchanBOT](t.me/Shinchan_USERBOT) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your shinchanbot server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of shinchanbot repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your shinchanbot server'
).add_command(
