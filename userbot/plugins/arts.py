...
@bot.on(admin_cmd(pattern=r"shinchano$"))
@bot.on(sudo_cmd(pattern="shinchano$", allow_sudo=True))
async def bluedevilshinchano(shinchano):
    if shinchano.fwd_from:
        return
    await edit_or_reply(shinchano, K)
