...
@shinchanbot.on(admin_cmd(pattern="cosec ?(.*)"))
@shinchanbot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@shinchanbot.on(admin_cmd(pattern="sec ?(.*)"))
@shinchanbot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@shinchanbot.on(admin_cmd(pattern="cot ?(.*)"))
@shinchanbot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@shinchanbot.on(admin_cmd(pattern="square ?(.*)"))
@shinchanbot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
