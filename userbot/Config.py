...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "shinchanBot")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/Shinchan7222/ShinchanOP"
        )
        ...
        EXTRA_shinchanBOT = os.environ.get("EXTRA_shinchanBOT", -1001221881562)
