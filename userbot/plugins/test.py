...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await edit_or_reply(event, "`Testing ShinchanBot`")
        ...
        await asyncio.sleep(2)
        await edit_or_reply(event, "**SAVING OUTPUT TO SHINCHANBOT LOCAL DATABASE**")
        await asyncio.sleep(3.5)
        await edit_or_reply(event, 
            "Your[ShinchanBot](https://t.me/Shinchan_USERBOT) is working Fine...\n       Join @Shinchan_USERBOT For Any Help......"
        )
