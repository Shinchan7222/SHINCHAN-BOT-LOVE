...
@shinchanbot.on(admin_cmd(pattern=r"unpack", outgoing=True))
@shinchanbot.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@shinchanbot.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@shinchanbot.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
