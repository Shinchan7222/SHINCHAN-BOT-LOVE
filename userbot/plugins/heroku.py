...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            " Please make sure your Heroku API Key, Your App name are configured correctly in the heroku\n\n[Visit Support Group For Help](https://t.me/Shinchan_userbot_chat)"
        )
    shinchan_data = app.get_log()
    shinchan_key = (
        requests.post("https://nekobin.com/api/documents", json={"content": shinchan_data})
        .json()
        .get("result")
        .get("key")
    )
    shinchan_url = f"⚡ Pasted this logs.txt to [NekoBin](https://nekobin.com/{Shinchan_key}) && [RAW PAGE](https://nekobin.com/raw/{Shinchan_key}) ⚡"
