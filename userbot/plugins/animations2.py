...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](Shinchan7222/ShinchanOP)**",
        ...
        "__INFO:ShinchanBot:Logged in as 557667062__",
        "__INFO:ShinchanBot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
